...
public class IncomeFragment extends BaseFragment {
	...
	public static IncomeFragment newInstance(String startTimestamp, String endTimestamp) {
	...
	private void getList() {
		...
		params.addQueryStringParameter("end_time", endDate);
...
//						Type type = new TypeToken<ArrayList<IncomeAndExpensesEntity>>() {
//						}.getType();
//						list.addAll((ArrayList<IncomeAndExpensesEntity>) gson.fromJson(lists.toString(), type));
