...
import com.yhy.hzzll.listener.CBPageChangeListener;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    public ConvenientBanner setPages(CBViewHolderCreator holderCreator,List<BannerEntity.DataBean> photolist){
        this.mDatas = (List<T>) photolist;
    ...
    /**
     * 监听item点击
     * @param onItemCListener
     */
    public ConvenientBanner setOnItemClickListener(OnItemCListener onItemCListener) {
        if (onItemCListener == null) {
            viewPager.setOnItemClickListener(null);
            return this;
        }
        viewPager.setOnItemClickListener(onItemCListener);
        return this;
    }
