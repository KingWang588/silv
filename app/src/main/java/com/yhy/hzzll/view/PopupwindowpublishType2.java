 ...
 * 
 */
public class PopupwindowpublishType2 extends PopupWindow implements
	...
	public PopupwindowpublishType2(final Activity context,
		...
		ColorDrawable dw = new ColorDrawable(200000000);
		...
		if (PublishCollaborationActivity.screentype1id1.isEmpty()) {
			getAllTypeStatus();
		} else {
			getTypeStatus();
		}
	...
	private void getTypeStatus() {
		httpDataUtils.sendGet(MyData.CHILDRENCATALOGBYID + "/"
				+ PublishCollaborationActivity.screentype1id1, null);
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			lawyer_job.addChangingListener(PopupwindowpublishType2.this);
			...
			btnSure.setOnClickListener(PopupwindowpublishType2.this);
			btn_myinfo_cancel.setOnClickListener(PopupwindowpublishType2.this);
