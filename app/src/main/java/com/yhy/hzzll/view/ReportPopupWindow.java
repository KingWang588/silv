 ...
 * 
 */
public class ReportPopupWindow extends PopupWindow implements
	...
	public ReportPopupWindow(final Activity context) {
		...
		conentView = inflater.inflate(R.layout.popupwindow_report, null);
		...
		jobList.add("发布不适当内容对我造成骚扰");
		jobList.add("传播带诱导分享性质的内容");
		jobList.add("传播谣言信息");
		jobList.add("传播色情信息");
		jobList.add("存在侵权行为");
		jobList.add("其他原因");
