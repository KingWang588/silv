 ...
 * @author Yang
 */
public class PopupwindowProvince extends PopupWindow implements
    ...
    private List<AddressEntity.AddressBean> provinceList;

    public PopupwindowProvince(final Activity context,List<AddressEntity.AddressBean> provinceList) {
...
//        provinceList = new ArrayList<>();
        ...
        tv_share_title.setText("选择省");
        setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_RESIZE);
        provinceList.clear();
        provinceList.add(new AddressEntity.AddressBean("000000000000", "-1", "不限",""));
        getType1Status();
    }
    ...
    private void getType1Status() {
        ...
        httpDataUtils.sendGet(MyData.GETADDRESS, params);
...
//							ProvinceEntity entity = gson.fromJson(
//									object.toString(), ProvinceEntity.class);
//							provinceList.add(entity);
//						}

                        AddressEntity addressEntity = gson.fromJson(arg0.result, AddressEntity.class);

                        provinceList.addAll(addressEntity.getData());


                        for (int j = 0; j < provinceList.size(); j++) {
                            jobList.add(provinceList.get(j).getArea_name());
                        }
                        ...
                        lawyer_job.addChangingListener(PopupwindowProvince.this);
                        ...
                        btnSure.setOnClickListener(PopupwindowProvince.this);
                        btn_myinfo_cancel.setOnClickListener(PopupwindowProvince.this);
